    ...
    <BoujtTemplate gap={50}>
      ...
      >
        <Flex flexDir={"column"} flex={3} gap={"20px"}>
          ...
          <Text>
            Vill du prata med någon? Handlar det kanske om något som känns
            jobbigt eller snarare kul? Det spelar ingen roll vad du vill prata
            om – du är alltid välkommen in till vår chatt. Vi erbjuder
            stödsamtal med utbildade syssnare. Du bestämmer själv om du vill
            kommunicera på svenskt teckenspråk eller skriven svenska.
          </Text>
          <Button
            marginTop={"auto"}
      ...
      >
        ...
        <Flex gap={3} flexDirection={shouldBreak ? "column" : "row"}>
          <Flex flexDir={"column"} gap={"20px"}>
            <Text>
              Du behöver aldrig oroa dig för att någon annan ska veta att du
              kontaktat oss. Vi har tystnadsplikt. Du är anonym så länge du inte
              talar om vad du heter eller eventuellt visar ditt ansikte i
              chatten. Vi kontaktar ingen så länge vi inte är riktigt oroliga
              för att du eller någon kan riskera att råka illa ut. Vi kontaktar
      ...
      <Flex flexDir={"column"} gap="50px">
        ...
        <Heading fontSize={"2xl"} textAlign={"center"} color={"blackish"}>
