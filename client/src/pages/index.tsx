      ...
      <Box position={"relative"} height="100vh">
        ...
        >
          ...
          <Flex flex={1} flexDir={"column"} maxW={"650px"}>
            ...
            <Text color={"white"}>
              I vår chatt kan du välja att prata om vad du vill! Har du en
              fundering om kroppen? Har du bråkat med en kompis? Säger din kille
              att du inte får träffa dina vänner? Är du ledsen, glad eller
              ingenting alls?
              <br />
              <br />
              Du är varmt välkommen att chatta med en syssnare! Du kan själv
              välja mellan text- eller videosamtal.
            </Text>
            {/* BUTTONS */}
